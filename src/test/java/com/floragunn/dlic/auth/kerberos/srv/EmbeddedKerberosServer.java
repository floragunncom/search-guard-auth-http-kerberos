...
package com.floragunn.dlic.auth.kerberos.srv;
...
public class EmbeddedKerberosServer {

    private final Logger log = LoggerFactory.getLogger(EmbeddedKerberosServer.class);
    ...
    public static void main(final String[] args) throws Exception {
        new EmbeddedKerberosServer().start();
    }
